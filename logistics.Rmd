...
params:
  ...
  ano: "2021"
  preambulo: "Preambulo"
  linha_pesquisa: "Logística e Cadeia de Suprimentos"
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="forecasting.Rmd"}
```
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="distributionCenter.Rmd"}
```
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="chargeDimensionAndRouting.Rmd"}
```
