...
Com base nos resultados obtidos é possível definir qual a melhor rota e melhor modal a ser utilizado. Obtendo o menor custo, no valor total de R`r scales::dollar_format(decimal.mark=",", big.mark = ".")(melhorRota$freteTotalPC)` opta-se então pela rota **Porto Belo $\to$ Itajaí $\to$ Santos $\to$ Palmas** com os carregamentos de São Paulo e Manaus e **Porto Belo $\to$ São Paulo** com o carregamento de São Paulo, utilizando o *container*  **Dry Box 20 Pés**, nos modais: cabotagem de Itajaí até Santos e rodoviário nos demais. Para tanto, serão utilizados `r melhorRota$quantidadesPC1` Dry Box 20 Pés de Porto Belo até São Paulo, `r melhorRota$quantidadesPC2` Dry Box 20 Pés de Porto Belo até Palmas  e `r melhorRota$quantidadesAM` Dry Box 20 Pés de Palmas Até Manaus. As rotas são apresentadas na Figura \@ref(fig:FIGROT001)
